...
/**
 * Signals that an error occured while working on a proxy.
 * 
 * @author Stefan Föll
 */
public class ProxyException extends Exception{
	...
	/**
	 * Constructs a new empty <code>ProxyException</code>.
	 */
	...
	/**
	 * Constructs a new <code>ProxyException</code> with the specified message.
	 */
	...
	/**
	 * Constructs a new <code>ProxyException</code> from the specified
	 * <code>Throwable</code>.
	 */
