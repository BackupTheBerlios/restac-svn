...
/**
 * Marker interface for Resources that support posting new content.
 * @author David Linner
 * 
 * 
 ...
 * 
 */
public interface Post extends Resource{
	/**
	 * Allows to post an input stream to this resource.
	 * @param in - input stream
	 * @throws ResourceException if input cannot be processed
	 */ 
