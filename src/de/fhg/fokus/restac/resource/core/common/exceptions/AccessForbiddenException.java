...
/**
 * Signals that a resource was attempted to be changed that is not allowed to be 
 * changed.
 * 
 ...
 */
public class AccessForbiddenException extends ResourceException {

	/**
	 * Constructs a new <code>AccessForbiddenException</code> with the specified message.
	 * 
