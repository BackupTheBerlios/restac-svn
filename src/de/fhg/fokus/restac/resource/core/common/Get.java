...
/**
 * Marker interface for Resources that support getting parametrized content.
 * @author David Linner
 * 
 * Last changed: 01.06.07 by Anna Kress
 * 
 */
public interface Get extends Resource{
	/**
	 * Allows to get the content to this resource.
	 * 
	 * @return the content of this resource
     * @throws
	*/
	HTTPXOutputStream get() throws ResourceException;
}
