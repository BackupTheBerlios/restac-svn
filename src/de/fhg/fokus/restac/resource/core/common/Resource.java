...
/**
 * Just a marker interface. A class implementing this interface should also
 * implement the marker interfaces for resource manipulation (e.g. Post, Get, etc.). 
 * A resource is associated with a node from a tree.  
 * 
