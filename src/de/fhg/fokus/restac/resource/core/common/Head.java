...
/**
 * Marker interface for Resources that accept a head call.
 * @author David Linner
 * 
 * Last changed: 01.06.07 by Anna Kress
 *  
 */
public interface Head extends Resource {
	/**
	 * Allows to check whether a parametrized resource is accessible.
	 * @throws
	 */
	void head() throws ResourceException;
}
