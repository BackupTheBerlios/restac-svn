...
/**
 * Sample implementation of a client for the ChunkEnabledMyResourceMessageHandler. 
 * Test client can handle chunked response!
 * 
 * Last changed by Anna Kress
 */
public class ChunkEnabledClientTestClass {

	private final static Logger LOGGER = Logger.getLogger(ChunkEnabledClientTestClass.class);
	...
	public static void main(String[] args) {
		...
		HTTPXActionMessageTransceiver transceiver = new HTTPXActionMessageTransceiver();
		...
		try {
			out = new HTTPXChunkedOutputStream(HTTPXConstants.TYPE_APP_URLENCODED, HTTPXConstants.DEFAULT_CHARSET);
