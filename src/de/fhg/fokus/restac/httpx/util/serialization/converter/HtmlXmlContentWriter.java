...
public class HtmlXmlContentWriter  extends ContentWriter {

	protected static final String myContentType = HTTPXConstants.TYPE_HTML_XML;
	
	public HtmlXmlContentWriter(HTTPXOutputStream out) throws ContentConvertingException {
	...
	public void write(Object obj) throws ContentConvertingException {
		byte[] array;
		try {
			array = HtmlXmlConverter.contentToByteArray((Document)obj, this.out.getContentCharset());
			out.write(array);
		} catch (IOException e) {
