...
public class UrlEncodedContentReader extends ContentReader {
	
	protected static final String myContentType = HTTPXConstants.TYPE_APP_URLENCODED;
	
	public UrlEncodedContentReader(HTTPXInputStream in) throws ContentConvertingException {
	...
	public Object read() throws ContentConvertingException {
		...
		return UrlEncodedConverter.byteArrayToContent(body, in.getContentCharset());
	}
