...
public class TextXmlContentWriter extends ContentWriter {

	protected static final String myContentType = HTTPXConstants.TYPE_TXT_XML;
	
	public TextXmlContentWriter(HTTPXOutputStream out) throws ContentConvertingException {
	...
	public void write(Object obj) throws ContentConvertingException {
		byte[] array;
		try {
			array = TextXmlConverter.contentToByteArray((Document)obj, this.out.getContentCharset());
			out.write(array);
		} catch (IOException e) {
