...
public class UrlEncodedContentWriter extends ContentWriter {

	protected static final String myContentType = HTTPXConstants.TYPE_APP_URLENCODED;
	
	public UrlEncodedContentWriter(HTTPXOutputStream out) throws ContentConvertingException {
	...
	public void write(Object obj) throws ContentConvertingException {
		byte[] array;
		try {
			array = UrlEncodedConverter.contentToByteArray((Map<String, String>)obj, this.out.getContentCharset());
			out.write(array);
		} catch (IOException e) {
