...
public class TextPlainContentReader extends ContentReader {
	
	protected static final String myContentType = HTTPXConstants.TYPE_TXT_PLAIN;
	
	public TextPlainContentReader(HTTPXInputStream in) throws ContentConvertingException {
	...
	public Object read() throws ContentConvertingException {
		...
		return TextPlainConverter.byteArrayToContent(body, in.getContentCharset());
	}
