...
/**
 * The Interface defines a asynchronous Handler that must be implemented and
 * registered as the Handler of an incoming or outgoing connection.  
 * 
 * @author Murat Ates
 */
public interface HTTPXAsynActionMessageHandler extends HTTPXActionMessageHandler {

	/**
	 * The asynchronous connection handler.
	 * 
